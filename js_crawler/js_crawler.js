...
function getPage(letter, pageNumber, callbackWhichTakesPageHtml) {
    var url = 'https://www.old.health.gov.il/units/pharmacy/trufot/Ycran_ListN.asp?p=' +
        pageNumber + '&' + 'Letter=' + letter + 'a&Sr_Type=T_Name&safa=e';
    var options = {
    ...
    request(options, function (error, response, body) {
        ...
        function prt(error, response, body) {
            ...
            request.get({
                url: url,
                headers: {cookie: xAaCookieValue},
                ciphers: 'DES-CBC3-SHA'
            }, function (error, response, body) {
                //console.log('body:', body, '\n', 'error:', error);
                callbackWhichTakesPageHtml(body);
            });
        }
